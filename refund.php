...
<section class="returns my-5">
    <h1 class="mt-5 py-5 text-center">Refund policy</h1>
    ...
    <div class="return-wrapper container">
       ...
       <p>If you are not satisfied with your SLAY BEAST order, you can return your products within 10 days of when you placed the order to receive a check for another product. We’ll process your return as soon as we receive it for the purchase amount minus the original shipping charges. Please note it may take up to 10 business days to get your check via email . </p>
