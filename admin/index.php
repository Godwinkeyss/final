        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo count($orders)   ?></p>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo count($products)   ?></p>
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo count($categories)   ?></p>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo count($complains)   ?></p>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">OrdersTable</p>
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div class="table-responsive">
                        <table id="example" class="display expandable-table" style="width:100%">
                          ...
                          <?php foreach( $orders as $order): ?>
                            ...
                            <th scope="row"data-title="Order Id">£<?php echo $order['order_cost']; ?></th>
                                    <td data-title="Order Status"><?php echo $order['order_status']; ?></td>
                                    <td data-title="User Id"><?php echo $order['user_id']; ?></td>
                                    
                                    <td data-title="Order Date"><?php echo $order['tracking_id']; ?></td>
                                    <td data-title="User Phone"><?php echo $order['email']; ?></td>
                                    <!-- <td data-title="User Phone"><?php echo $order['checkbox']; ?></td> -->
                                    <td data-title="User Phone"><?php echo $order['country']; ?></td>
                                    <td data-title="User Phone"><?php echo $order['first_name']; ?></td>
                                    <td data-title="User Address"><?php echo $order['last_name']; ?></td>
                                    <td data-title="User Address"><?php echo $order['phone']; ?></td>
                                    <td data-title="User Address"><?php echo $order['address']; ?></td>
                                    <td data-title="User Address"><?php echo $order['postal']; ?></td>
                                    <td data-title="User Address"><?php echo $order['state']; ?></td>
                                    <td data-title="User Address"><?php echo $order['city']; ?></td>
                                    <td data-title="User Address"><?php echo $order['order_date']; ?></td>
                                    <td data-title="Edit"><a href="edit_order.php?order_id=<?php echo $order['order_id'];  ?>" class="btn btn-primary btn-sm">Edit</a></td>
                                    <td data-title="Delete"><a href="delete_order.php?order_id=<?php  echo $order['order_id'];  ?>" class="btn btn-danger btn-sm">Delete</a></td>
                            </tr>
                            <?php endforeach;  ?>
                          </tbody>
                      </table>
